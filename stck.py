...
db_nbre = Database('Fe-Ni.tdb')
my_phases_nbre = ['LIQUID','FCC4','FCC_A1','BCC_A2','BCC4']
#'FCC4','BCC4'
...
for phase_name in my_phases_nbre:
    result = calculate(db_nbre, ['NI', 'FE','VA'], phase_name, P=101325, T=900, output='GM')
    ax.scatter(result.X.sel(component='FE'), result.GM, marker='.', s=5, color=color_dict[phase_name])
